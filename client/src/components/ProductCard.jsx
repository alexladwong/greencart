            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-end justify-between mt-3">
                    <p className="md:text-xl text-base font-medium text-primary">
                        {formatPrice(product.offerPrice, product.currency || "USD")}{" "} <span className="text-gray-500/60 md:text-sm text-xs line-through">{formatPrice(product.price, product.currency || "USD")}</span>
                    </p>
